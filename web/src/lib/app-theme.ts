...
export function getAntThemeConfig(dark: boolean): ThemeConfig {
    ...
    return {
        ...
        token: {
            ...
            controlItemBgHover: color.menuHoverBg,
            controlItemBgActive: color.menuSelectedBg,
            controlItemBgActiveHover: color.menuSelectedBg,
        },
        components: {
            Button: {
                primaryShadow: "none",
            ...
            Menu: {
                itemActiveBg: color.menuHoverBg,
                itemHoverBg: color.menuHoverBg,
                itemSelectedBg: color.menuSelectedBg,
                itemSelectedColor: color.menuText,
                darkItemHoverBg: sharedTokenAdapter.dark.menuHoverBg,
                darkItemSelectedBg: sharedTokenAdapter.dark.menuSelectedBg,
